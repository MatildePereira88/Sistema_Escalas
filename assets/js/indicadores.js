...
// Variável global para armazenar o tooltip atual (NÃO MAIS UTILIZADA NESSA ABORDAGEM)
let currentTooltip = null;

// Funções de tooltip de hover (REMOVIDAS DESSA ABORDAGEM)
function showHoverTooltip(element, contentHTML) { /* Removido */ }
function hideHoverTooltip() { /* Removido */ }
...
async function carregarEstatisticas() {
    ...
    try {
        ...
        // Preenche os cards KPI com os dados retornados (APENAS NÚMERO E LABEL)
        ...
        // As divs kpi-detail foram removidas do HTML para estes cards.
        // A lógica de tooltip/detalhe para eles será em seções separadas, se adicionadas.
...
// Funções auxiliares de formatação (mantidas, mas não chamadas para os cards KPI principais)
...
function formatDetalheCargos(detalhes) {
    ...
    tableHTML += '</tbody></table>';
    return html; // Corrigido aqui: deve retornar tableHTML
}
